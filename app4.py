...
def main():
    ...
    tab1, tab2, tab3 = st.tabs(["Property Details", "Prediction Results", "Feature Analysis"])
    ...
    with tab1:
        ...
        if predict_button:
            ...
            try:
                ...
                st.success("Prediction successful! Check the 'Prediction Results' tab.")
            except Exception as e:
    ...
    with tab2:
        ...
        if 'prediction' not in st.session_state:
            st.info("Please enter property details and click 'Predict Rent Price' to see results.")
        else:
            ...
            with col1:
                ...
                st.markdown(f'<h3 style="color: #1f77b4;">Estimated Rent Price</h3>', unsafe_allow_html=True)
    ...
    with tab3:
        ...
        if 'processed_df' not in st.session_state:
            st.info("Please enter property details and click 'Predict Rent Price' to see feature analysis.")
        else:
            ...
            # Feature values for the current property
            st.markdown('<div class="feature-importance">', unsafe_allow_html=True)
